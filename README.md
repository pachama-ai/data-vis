...
| **Tagesmuster** | – | (entfernt – Heatmap wurde nicht ins Frontend übernommen) |
...
| Enter/Update/Exit mit Key-Accessor | Nur in `ScatterAnalysis.vue` (Punkte-Join) | Bei Aggregatswechsel (HourlyProfile) ist komplettes Neuzeichnen nötig und schneller als diff |
